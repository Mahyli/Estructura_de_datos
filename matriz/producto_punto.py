...
# Asegúrate de instalar numpy antes de ejecutar el script:
# Puedes instalarlo ejecutando en la terminal: pip install numpy
...
pesos = np.array([[0.5, 0.2], [0.8, 0.3], [0.1, 0.9]])

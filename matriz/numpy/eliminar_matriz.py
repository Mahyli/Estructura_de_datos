...
datos = np.array([[10, 20, 30, 40], [15, 20, 35, 45], [25, 20, 45, 55]])

print("--- Conjunto de datos original ---")
print(datos)

# 2. Elimina la columna de datos irrelevantes
# np.delate() se utiliza para eliminar elementos o filas/columnas.
